...
I build intelligent systems that turn **images, documents, and real-world data** into useful applications.

[![Email](https://img.shields.io/badge/Email-duyquangv2yb%40gmail.com-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:duyquangv2yb@gmail.com)
[![GitHub](https://img.shields.io/badge/GitHub-PhamQuang138-181717?style=for-the-badge&logo=github)](https://github.com/PhamQuang138)
![Profile Views](https://komarev.com/ghpvc/?username=PhamQuang138&style=for-the-badge&color=7B2FF7&label=PROFILE+VIEWS)
...
### 🛰️ [Oil Spill SAR Segmentation](https://github.com/PhamQuang138/oil-spill-sar-segmentation)

An end-to-end deep learning pipeline for detecting and segmenting suspected oil spills in **Synthetic Aperture Radar (SAR)** imagery.

`DeepLabV3+` · `SegFormer` · `UNet++` · `PyTorch` · `Streamlit` · `Model Ensemble`

- Compares three semantic-segmentation architectures
...
`Llama 3.2` · `LoRA` · `Qwen Embeddings` · `ChromaDB` · `BM25` · `Gradio`

- Combines vector search and keyword search in a hybrid retrieval pipeline
...
`React 19` · `TypeScript` · `Express` · `Prisma` · `PostgreSQL` · `OpenRouter`

- Built as a frontend/backend monorepo
...
`Python` · `FastAPI` · `Telegram Bot API` · `SQLite` · `AI APIs`

- Manages an admin-curated affiliate link catalog by campaign and category
- Generates engagement content and supports Threads publishing workflows
- Tracks link clicks and campaign analytics
...
<img width="95%" src="https://github-readme-activity-graph.vercel.app/graph?username=PhamQuang138&bg_color=0d1117&color=7B2FF7&line=00C9FF&point=F107A3&area=true&hide_border=true" alt="Contribution activity graph" />
...
I'm open to **AI/ML collaborations, research projects, internships, and interesting ideas involving computer vision or geospatial data**.

📧 **Email:** [duyquangv2yb@gmail.com](mailto:duyquangv2yb@gmail.com)
